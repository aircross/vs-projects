...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->cbParity->Items->AddRange(gcnew cli::array< System::Object^  >(5) {L"无校验", L"奇校验", L"偶校验", L"标记校验", L"空格校验"});
			...
			this->cbStreamCtl->Items->AddRange(gcnew cli::array< System::Object^  >(4) {L"DTR_DSR", L"RTS_CTS", L"XON_XOFF", L"NO_HANDSHAKE"});
